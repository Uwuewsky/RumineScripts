// ==UserScript==
// @name         Rumine Ignore List [New2 Template]
// @version      3.1
...
// @grant        none
// @updateURL    https://raw.githubusercontent.com/Uwuewsky/RumineScripts/refs/heads/master/ignore_script/ignore-list-rework.user.js
// @downloadURL  https://raw.githubusercontent.com/Uwuewsky/RumineScripts/refs/heads/master/ignore_script/ignore-list-rework.user.js
// ==/UserScript==
...
function initInterface() {
     ...
     */
    let menu = document.querySelector("[menu-id='profile'] > .dropdown__items");
    ...
    popup.innerHTML = `<button class="b01" id="ignorePopupExit">X</button>
    <button class="b01" id="ignorePopupSubmit">Принять изменения</button>
    <button class="b01" id="ignorePopupToDefault">Сбросить настройки</button>
    
    <span>Настройки скрипта для игнорирования постов:</span>
    
    <fieldset>
      <legend>Игнорирование пользователей</legend>
      <label>Добавить юзера в список: <input id="ignoreNicknameAdd" type="text"> <button class="b01" id="ignoreNicknameAddSubmit">✓</button></label>
    ...
    <fieldset>
      ...
      <label>Добавить сообщение в список:
        ...
        <button class="b01" id="ignoreUniqueMessageAddSubmit">✓</button>
      </label>
