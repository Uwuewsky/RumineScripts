// ==UserScript==
// @name         Rumine Ignore List [Mobile]
// @version      3.1
...
// @grant        none
// @updateURL    https://raw.githubusercontent.com/Uwuewsky/RumineScripts/refs/heads/master/ignore_script/ignore-list-mobile.user.js
// @downloadURL  https://raw.githubusercontent.com/Uwuewsky/RumineScripts/refs/heads/master/ignore_script/ignore-list-mobile.user.js
// ==/UserScript==
...
function getNicknameFromMessage(e) {
     ...
     */
    return e.querySelector(".namestyle > a").textContent;
}
...
function getMessagesCountFromMessage(e) {
     ...
     */
    let str = e.querySelector(".blockinfo1").textContent;
    return parseInt(str.slice(str.search("Сообщений: ") + 11, str.search("Симпатий: ") - 16));
}
...
function injectStyles() {
    ...
    ${messageSelector}.hidden > .msginfoa,
